    ...
    return (
      ...
      <div className='bg-slate-800 pt-5' style={{fontFamily: "Roboto Mono"}}>
        ...
        <div className='min-h-screen flex justify-center justify-items-center align-items-center'>
            <div>
                <h1 className='text-exclpurple font-bold text-7xl text-center'>Failed to upload a resource</h1>
                <h1 className='text-white text-4xl text-center'>Close this window and try again using bot command</h1>
            </div>
        </div>
