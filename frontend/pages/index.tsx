          ...
          <section className="lg:pl-20 lg:pt-12 pl-5 pt-10 lg:pr-20 pr-5">
            ...
            <nav>  
                <div className={styles.headerButtonSection}>
                    <Link href="https://discord.com/api/oauth2/authorize?client_id=917954795384500236&redirect_uri=http%3A%2F%2Fapi.examclutch.com%2Fapi%2Foauth2%2Fredirect&response_type=code&scope=identify%20email%20guilds">
